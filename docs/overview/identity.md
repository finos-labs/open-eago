...
> Consolidated normative identity model, requirements, claims, lifecycle, and conformance profiles are defined in the enhanced section later in this document.
...
2.4. Central Authority returns response:
     {
       ...
       "security_policy": {
         ...
         "network_policy": ["registry.eago.local", "auth.eago.local"]
       }
     }
```
